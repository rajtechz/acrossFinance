...
//   // Handler for editing caseCount
//   const handleCaseCountChange = (batchNo, newValue) => {
//     const updatedRows = selectedRows.map((row) =>
//       row.batchNo === batchNo ? { ...row, caseCount: newValue } : row
//     );
//     setSelectedRows(updatedRows);
//   };
...
//             : [], // Initialize selectedAaNos based on initial caseCount
//         }))
//       );
//     }
//   }, [selectedBatches]);
...
//   // Handler for editing caseCount and updating selected aaNos
//   const handleCaseCountChange = (batchNo, newValue) => {
//     const newCount = Math.max(0, parseInt(newValue) || 0); // Ensure non-negative number
//     const updatedRows = selectedRows.map((row) => {
...
//           const payload = {
//             scheduledId: row.batchNo || "N/A",
//             aaNo: row.selectedAaNos.join(", ") || "", // Use selected aaNos
//             imeiNo: row.imeiNo || "",
//             creationDate: row.creationDate || "",
//             closureDate: row.closureDate || "",
//             customerName: row.customerName || "",
